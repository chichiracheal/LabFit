...
<main class="form-signin w-100 m-auto">
	...
	<div>
		...
		<h1 class="h3 mb-3 text-center mt-4 ">WELCOME BACK </h1>
			<h2 style="color:#999;" class=" ">Log In</h2>
...
?>
      ...
      <label for="floatingPassword">Password</label>
				...
				<button type="submit" class="btn3" name="btnlogin" value="Login">Login</button>
				<div class="logreg-link">
					
          <p style="color:#999;"> Don't have account? <a href="register.php" class="register-link" id="signup">Signup</a>   </p>
				</div>
			</form>
		</div>
	</div>
